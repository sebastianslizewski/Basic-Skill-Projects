...
public class BoardTest {
    ...
    public void shouldAddDestroyerOnFields() throws Exception {
        //arrange
        //act
        board.addShip(0, 0, new TwoMasts(WarShip.Orientation.HORIZONTAL));
        //assert
    ...
    public void shouldNotBeAbleToGetOutside() throws Exception {
        //arrange
        //act
        board.addShip(9, 0, new TwoMasts(WarShip.Orientation.HORIZONTAL));
    ...
    public void shouldNotBeAbleToBeClose() throws Exception {
        ...
        board.addShip(0,0, new TwoMasts(WarShip.Orientation.HORIZONTAL));
        //act
        board.addShip(2,0, new TwoMasts(WarShip.Orientation.HORIZONTAL));
    }
    ...
    public void shouldNotBeAbleToAddTwoBattleships() throws Exception {
        //arrange
        board.addShip(0,0, new FourMasts(WarShip.Orientation.HORIZONTAL));
        //act
        board.addShip(6,0, new FourMasts(WarShip.Orientation.HORIZONTAL));
    }
